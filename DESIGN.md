...
- **Contact** (`.section--contact`): the page ends on the ask, not on a chip cloud. Headline, one lede line, email as the primary button, LinkedIn and Resume ghost.
